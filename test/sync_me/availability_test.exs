defmodule SyncMe.AvailabilityTest do
  ...
  describe "availability_rules" do
    ...
    test "get_availability_rule!/2 returns the availability_rule with given id" do
      ...
      assert_raise Ecto.NoResultsError, fn ->
        Availability.get_availability_rule!(other_scope, availability_rule.id)
      end
    end
    ...
    test "create_availability_rule/2 with valid data creates a availability_rule" do
      ...
      assert {:ok, %AvailabilityRule{} = availability_rule} =
               Availability.create_availability_rule(scope, valid_attrs)
    ...
    test "create_availability_rule/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Availability.create_availability_rule(scope, @invalid_attrs)
    end
    ...
    test "update_availability_rule/3 with valid data updates the availability_rule" do
      ...
      assert {:ok, %AvailabilityRule{} = availability_rule} =
               Availability.update_availability_rule(scope, availability_rule, update_attrs)
    ...
    test "update_availability_rule/3 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Availability.update_availability_rule(scope, availability_rule, @invalid_attrs)
    ...
    test "delete_availability_rule/2 deletes the availability_rule" do
      ...
      assert {:ok, %AvailabilityRule{}} =
               Availability.delete_availability_rule(scope, availability_rule)

      assert_raise Ecto.NoResultsError, fn ->
        Availability.get_availability_rule!(scope, availability_rule.id)
      end
    end
    ...
    test "delete_availability_rule/2 with invalid scope raises" do
      ...
      assert_raise MatchError, fn ->
        Availability.delete_availability_rule(other_scope, availability_rule)
      end
    end
  ...
  describe "availability_overrides" do
    ...
    test "list_availability_overrides/1 returns all scoped availability_overrides" do
      ...
      assert Availability.list_availability_overrides(other_scope) == [
               other_availability_override
             ]
    end
    ...
    test "get_availability_override!/2 returns the availability_override with given id" do
      ...
      assert Availability.get_availability_override!(scope, availability_override.id) ==
               availability_override

      assert_raise Ecto.NoResultsError, fn ->
        Availability.get_availability_override!(other_scope, availability_override.id)
      end
    end
    ...
    test "create_availability_override/2 with valid data creates a availability_override" do
      ...
      assert {:ok, %AvailabilityOverride{} = availability_override} =
               Availability.create_availability_override(scope, valid_attrs)
    ...
    test "create_availability_override/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Availability.create_availability_override(scope, @invalid_attrs)
    end
    ...
    test "update_availability_override/3 with valid data updates the availability_override" do
      ...
      assert {:ok, %AvailabilityOverride{} = availability_override} =
               Availability.update_availability_override(
                 scope,
                 availability_override,
                 update_attrs
               )
    ...
    test "update_availability_override/3 with invalid data returns error changeset" do
      ...
      assert availability_override ==
               Availability.get_availability_override!(scope, availability_override.id)
    end
    ...
    test "delete_availability_override/2 deletes the availability_override" do
      ...
      assert {:ok, %AvailabilityOverride{}} =
               Availability.delete_availability_override(scope, availability_override)
    ...
    test "delete_availability_override/2 with invalid scope raises" do
      ...
      assert_raise MatchError, fn ->
        Availability.delete_availability_override(other_scope, availability_override)
      end
    end
    ...
    test "change_availability_override/2 returns a availability_override changeset" do
      ...
      assert %Ecto.Changeset{} =
               Availability.change_availability_override(scope, availability_override)
    end
  end
end
